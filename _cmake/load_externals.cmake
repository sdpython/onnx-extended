...
message(STATUS "-------------------")
find_package(LocalNanobind REQUIRED)
if(LocalNanobind_FOUND)
  message(STATUS "Found LocalNanobind, Nanobind at ${nanobind_SOURCE_DIR}")
  message(STATUS "Found nanobind ${nanobind_VERSION}")
else()
  message(FATAL_ERROR "Module nanobind is not installed.")
endif()
...
message(STATUS "-------------------")
find_package(LocalGoogleTest REQUIRED)
if(LocalGoogleTest_FOUND)
  message(STATUS "Found GoogleTest ${GoogleTest_VERSION}")
  message(STATUS "Found LOCAL_GTEST_URL ${LOCAL_GTEST_URL}")
  message(STATUS "googletest_SOURCE_DIR=${googletest_SOURCE_DIR}")
  message(STATUS "googletest_BINARY_DIR=${googletest_BINARY_DIR}")
else()
  message(FATAL_ERROR "Module GoogleTest is not installed.")
endif()
