...
class TestCReferenceEvaluatorSave(ExtTestCase):
    @staticmethod
    ...
    def test_reference_evaluator_save(self):
        ...
        with tempfile.TemporaryDirectory() as root:
            ...
            ref = CReferenceEvaluator(onx, save_intermediate=path)
    ...
    def test_reference_evaluator_custom_runtime_save(self):
        ...
        with tempfile.TemporaryDirectory() as root:
            ...
            class NewRef(CReferenceEvaluator):
                n_inits = 0
                n_calls = 0
                ...
                def run(self, *args, **kwargs):
                    NewRef.n_calls += 1
                    return CReferenceEvaluator.run(self, *args, **kwargs)

            new_cls = CReferenceEvaluatorBackend[NewRef]  # type: ignore[type-arg]
