...
struct CustomTreeAssemblyKernel {
  CustomTreeAssemblyKernel(const OrtApi &api, const OrtKernelInfo *info,
                           bool classifier);
...
struct CustomTreeAssemblyOp
  ...
  typedef Ort::CustomOpBase<CustomTreeAssemblyOp, CustomTreeAssemblyKernel>
      parent_type;
  CustomTreeAssemblyOp(bool classifier)
      : parent_type(), classifier_(classifier) {}
