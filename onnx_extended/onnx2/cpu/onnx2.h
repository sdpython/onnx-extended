...
FIELD(utils::String, key, 1)
FIELD(utils::String, value, 2)
END_PROTO()
...
FIELD(utils::String, dim_param, 2)
...
FIELD_OPTIONAL(int64_t, dim_value, 1)
FIELD(utils::String, dim_param, 2)
FIELD(utils::String, denotation, 3)
END_PROTO()
...
FIELD(utils::String, doc_string, 12)
...
FIELD(utils::String, denotation, 6)
