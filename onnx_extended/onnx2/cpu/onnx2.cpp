...
/*
void StringStringEntryProto::CopyFrom(const StringStringEntryProto &proto) {
...
std::vector<std::string> StringStringEntryProto::PrintToVectorString(
...
std::vector<std::string> DeviceConfigurationProto::PrintToVectorString(
    utils::PrintOptions &options) const {
...
std::vector<std::string> SimpleShardedDimProto::PrintToVectorString(
    utils::PrintOptions &options) const {
...
std::vector<std::string> NodeDeviceConfigurationProto::PrintToVectorString(
    utils::PrintOptions &options) const {
...
std::vector<std::string> TensorShapeProto::Dimension::PrintToVectorString(
    utils::PrintOptions &options) const {
  return write_proto_into_vector_string(options, NAME_EXIST_VALUE(dim_value),
...
std::vector<std::string> TypeProto::SparseTensor::PrintToVectorString(
    utils::PrintOptions &options) const {
  return write_proto_into_vector_string(options, NAME_EXIST_VALUE(elem_type), NAME_EXIST_VALUE(shape));
}
